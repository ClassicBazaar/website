...
function render() {
    featured.forEach((feature) => {
        productel.innerHTML += `
     <div class="col-md-4 mt-3 mb-5" style="z-index:0;">
     <div class="card" >
         <img
             src="${feature.image}"
             class="card-img-top"
         ...
         <div class="card-body">
             ...
             <p class="card-text card-price">From<span style="color: #896633;"> ${feature.price}</span></p>
             <a  class="btn text-white mt-2" style="background-color: #896633" onclick="order(${feature.id})" >Buy now</a>
             <a class="btn text-white mt-2 details-btn"  style="background-color: #896633" onclick="details(${feature.id})" >View details</a>
         </div>
     </div>
 </div>
     `;
...
//order
//starting
let buypage = document.querySelector("#order-page");
function order(id) {
    const product = featured.find((features) => features.id === id);
    buypage.innerHTML += `
                ...
                <form  action="https://script.google.com/macros/s/AKfycbwqW6sGPdfSSFuicqRMFY0z9ry6gJY3TtLR7tOBuoLbzQfdt6H22RkBx31y4ryv_AD6sQ/exec" method="post" class="order-pop">
                    ...
                    <!-- pincode -->
                        ...
                        <div class="col-6 mt-4 mb-4 m-auto">
                            <input required type="submit" class="btn bg-white text-dark form-control submit" placeholder="Order" onclick="pop()"/>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="container-fluid">
        <div class="row pb-5">
            ...
            <div class="col-md-6 col-12 mt-4">
                <h6 class="text-white mt-4">Featured</h6>
                ...
                <a onclick="order(${product.id}) " class="btn text-white mt-3 buy-button" style="background-color: #896633">Buy now</a>
